...
cap %>% 
  filter(year(date)>=2017, fuel=='YTD', grepl('New', var)) %>% 
  ...
  write_csv('2022Q2 analysis/newly added power capacity.csv') %>% 
...
ggsave(paste0('2022Q2 analysis/Newly added power capacity, January to July, ',lang,'.png'), width=8, height=6)
